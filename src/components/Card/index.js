...
export default function Card() {
    ...
    // Defining a title and description for the todo item
    ...
    return (
        <div>
            ...
            <div className="card-style">
                <h3 className='card-title'>{todoTitle}</h3> {/* Displaying the Todo Title */}
                <p className="card-desc">{todoDesc}</p> {/* Displaying the Todo Description */}
